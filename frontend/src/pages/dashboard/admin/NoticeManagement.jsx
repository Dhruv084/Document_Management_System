    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Create and manage notices for all users</p>
        </div>
        <button
          onClick={() => {
            resetForm();
            ...
            <div>
              ...
              {editingNotice && editingNotice.attachments && editingNotice.attachments.length > 0 && (
                <p className="mt-2 text-sm text-gray-600">
                  Existing attachments: {editingNotice.attachments.length} file(s) will be kept. New files will be added.
                </p>
              )}
            </div>
            <button
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                {notice.postedBy && (
                  <span className="px-3 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">
                    {notice.postedBy.name} ({notice.postedBy.role})
                  </span>
                )}
